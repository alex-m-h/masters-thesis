...
$\psi$ matters. 
% One reason for that could be that we have to approximate the 
% integral
% \begin{align*}
%     \int_{\Omega_{\Gamma_j}} \psi_j \, J \, dx
% \end{align*}
% for $j=1,2$ which has to be computed numerically and thus introduce another source of 
% error.
