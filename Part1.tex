...
\begin{proof}
    ...
    \end{align*}
    { \color{red}
        I did not achieve to show the following yet. There was a mistake in my
        original reasoning.
        Can we find a sequence  $(\phi_l) \subseteq H^1(\Omega)$ s.t. 
        $\nabla\phi_l \rightarrow \nabla\phi$ in $L^2(\Omega)$?
        If so then $\nabla \phi \in \overline{\nabla H^1(\Omega)}$.
        Then $\nabla \phi = 0$ because $B - \tilde{B} \in 
        \overline{\nabla H^1(\Omega)}^\perp.$ 
        Or can we show $\nabla \phi = 0$ in a different way?
    }
    ...
    % $B = \tilde{B}$. 
    If the corresponding vector proxies are equal we 
