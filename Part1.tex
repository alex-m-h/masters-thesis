...
\begin{definition}[Zero boundary condition]
...
\begin{proof}
    ...
    \end{align*}
    $\varphi$ is an isometry by construction.
\end{proof}
...
\begin{remark}
    ...
    of the operator which we want to avoid as it involves several steps 
    and is quite technical. Thus, 
...
Sec.\,\ref{sec_isomorphism_cohomology}. 
...
directly. Let us also assume that $\eta$ is closed and 
