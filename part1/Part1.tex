...
\begin{figure}
    ...
    \begin{minipage}[c]{.5\textwidth}
        \begin{tikzpicture}[scale=5]
            ...
            \draw (-0.01,1) -- (0.01,1);
            \draw (1,0) -- (0,1);
            \node[label={below:$(1,0)$}] at (1,0) {};
            \node[label={below:$(0,1)$}] at (0,1) {};
        \end{tikzpicture}        
    \end{minipage}
    ${\large\rightarrow}$
    \begin{minipage}[c]{.3\textwidth}
        ...
        \begin{tikzpicture}[scale=0.3]
            \centering
            \draw[->] (0,0) .. controls (2.5,7) and (7.5,3) .. (10,10);
        \end{tikzpicture}        
    \end{minipage}
...
\begin{figure}
    ...
    \begin{minipage}[c]{0.5\textwidth}
        \begin{tikzpicture}[scale=3]
            ...
            \node[label={below:$(1,0,0)$}] at (1,0,0) {};
            \node[label={below:$(0,1,0)$}] at (0,1,0) {};
            \node[label={below:$(0,0,1)$}] at (0,0,1) {};
            \filldraw[gray, opacity=0.5] (1,0,0) -- (0,1,0) -- (0,0,1) -- (1,0,0);
        \end{tikzpicture}
    \end{minipage}
    ...
    \begin{tikzpicture}[scale=0.5]
        \draw[->] (0,0)  .. controls (0.25,-0.25) and (0.75,-1) .. (10,3)
