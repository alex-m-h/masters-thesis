...
Most of the proofs are very short and we will give them in detail. 
...
\end{lemma}
\begin{proof}
    Since the argument is not too complicated and we will only sketch it.
